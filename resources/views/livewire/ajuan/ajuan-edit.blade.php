...
new class extends Component
{
    ...
    public function openModelEdit($name, $rowId)
    {
        $ajuan = Ajuan::findOrFail($rowId);
        $this->id = $ajuan->id;
...
<section>
    <x-modal name="open-edit-ajuan" :show="$errors->isNotEmpty()" maxWidth="max" focusable wire:key="modal-edit-ajuan">
        <div class="p-4 space-y-4">
            ...
            <form wire:submit="store" class="space-y-6 space-x-3">
