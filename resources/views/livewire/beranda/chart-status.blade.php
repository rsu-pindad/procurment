...
<div class="p-4 sm:p-8 bg-white shadow rounded-md">
    ...
    <div class="flex flex-col sm:flex-row flex-wrap gap-2 mb-4 pb-2 border-b-2 border-slate-200">
        ...
        <x-secondary-button class="w-full sm:w-auto border-yellow-600 hover:bg-yellow-50 hover:text-yellow-600" id="export-chart-status-btn">
...
<script type="application/json" id="statusChartLabels">
    @json($this->statusChartData['labels'])
</script>

<script type="application/json" id="statusChartData">
    @json($this->statusChartData['data'])
</script>
@endpushOnce
